...
export function defaultMedidas() {
  return Object.fromEntries(MEDIDAS_LABEL.map((m) => [m.key, ""]));
}
export function defaultMedidasMetas() {
  return Object.fromEntries(MEDIDAS_LABEL.map((m) => [m.key, ""]));
}
...
export function defaultRefeicoes() {
  return [
...
export function defaultCompras() {
  return [
...
export function defaultReceitas() {
  return [
...
export function defaultTreinoGenerico() {
  return [
