...
import { itensDaRefeicao, somaItens } from "@/lib/points";
...
function MealRow({ meal, itens, onAdd, onRemove, catalog }) {
        ...
        {open && (
          <div style={{ marginTop: 8, background: CARD2, borderRadius: 10, padding: 10 }}>
            <div style={{ display: "flex", gap: 6, marginBottom: 8 }}>
              {[["catalogo", "Meus alimentos"], ["livre", "Lançamento livre"]].map(([k, l]) => (
...
export default function RefeicoesHojeScreen({ data, nav }) {
