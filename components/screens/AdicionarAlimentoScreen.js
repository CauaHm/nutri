...
import { PINK, PURP, GRN, AMB, SUB, BORDER, TEXT, sCard, sInp, sLbl, sBtn } from "@/lib/theme";

const EMPTY_FORM = { nome: "", porcaoDesc: "", kcal: "", proteina: "", carbo: "", gordura: "" };
...
export default function AdicionarAlimentoScreen({ data, nav }) {
  ...
  const [status, setStatus] = useState("idle"); // idle | analisando | erro | sem_api | ok
    ...
    <div style={{ minHeight: "100%", paddingBottom: 60 }}>
      ...
      <div style={{ padding: 14 }}>
        <div style={{ display: "flex", gap: 8, marginBottom: 14 }}>
          {[["foto", "📷 Analisar foto"], ["manual", "✏️ Manual"]].map(([k, l]) => (
