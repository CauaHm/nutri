...
import { CARD, SUB, BORDER, TEXT, sCard, sInp, sLbl, sBtn } from "@/lib/theme";

function SortableDay({ id, d, i, reorder, user, onOpen }) {
...
export default function TreinoScreen({ data, nav }) {
